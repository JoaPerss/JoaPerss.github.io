    ...
    return (
        <ul className="flex flex-wrap gap-4 justify-center">
            {skillsImage.map(skillImage => (
                <li key={skillImage} className="text-center font-aloevera w-full md:w-auto">
                    <img className="h-32 md:h-48" src={skillImage} alt="Pictures of skills" draggable="false" />
                </li>
            ))}
        </ul>
    );
